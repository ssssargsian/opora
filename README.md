...
3. Специалист получает одноразовую ссылку, действующую 48 часов, и самостоятельно задаёт пароль. Production SMTP настраивается только environment variables из `deploy/README.md`.
